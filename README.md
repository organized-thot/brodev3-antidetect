...
### Profiles
Profiles is a individual browser instances, similar to profiles in the Google Chrome browser. Each profile has its own storage, settings, and data, which are stored locally on your system for increased confidentiality and security.
<p align="center">
...
1. Create an account on [Baserow](https://baserow.io/).
2. Create a new database and a table.
3. Configure the table to hold profile information (name, proxy, fingerprint status, etc.).
...
- **BASEROW_TABLE_ID**: The ID of the Baserow table you created.
